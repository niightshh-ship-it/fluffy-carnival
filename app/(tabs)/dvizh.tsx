  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.center}>
        <Text style={styles.label}>ДВИЖ</Text>
        <Text style={styles.sub}>скоро здесь появятся квесты</Text>
      </View>
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  label: { fontFamily: Fonts.bold, fontSize: FontSize.xxl, color: Colors.lime },
